...
html_logo = "img/logo/logo_wide.png"
...
# pixels large.
html_favicon = "img/favicons/icon.ico"
...
def setup(app):
    app.add_css_file("probnum-evaluation-style.css")  # also can be a full URL
...
sphinx_gallery_conf = {
    "default_thumb_file": "img/logo/logo_wide.png"  # default thumbnail image
}
